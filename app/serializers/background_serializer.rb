  ...
  def self.serialize(background_images)
    {
      data: {
        background_images: [
          ...
          {
            alt: background_images[8][:title],
            url: "https://www.flickr.com/photos/#{background_images[8][:owner]}/#{background_images[8][:id]}"
          },
          {
            alt: background_images[9][:title],
            url: "https://www.flickr.com/photos/#{background_images[9][:owner]}/#{background_images[9][:id]}"
          }
        ]
      }
    }
